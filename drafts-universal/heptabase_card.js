// ═══════════════════════════════════════════════════════════════
// Heptabase Card — 保存为笔记卡片 (Mac + iPhone)
// ═══════════════════════════════════════════════════════════════
...
function main() {
    ...
    var result = callMCP(tokenData.access_token, "save_to_note_card", {
        content: content
    });
    ...
    tokenData = refreshIfNeeded(tokenData);
    if (tokenData) {
        result = callMCP(tokenData.access_token, "save_to_note_card", { content: content });
        if (result.success) {
            app.displaySuccessMessage("✅ 已保存为卡片");
            return;
        }
